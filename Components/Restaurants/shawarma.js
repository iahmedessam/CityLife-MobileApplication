...
const Shawarma = () => {
    const { shawarma, fontsLoaded } = useContext(DataContext);
    ...
    return (
        ...
        <Text style={{ fontSize: 20, fontWeight: "bold", marginLeft: 21, color:"#112D4E", marginTop:20}}>Shawarma Restaurants</Text>
        {shawarma.map((ele) => (
