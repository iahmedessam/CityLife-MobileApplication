...
<ScrollView style={{backgroundColor:"white"}}>
      ...
      <Text style={styles.textP}>
        ...
        residential scheme within the New Cairo plan. AL-Rehab is the hub of New
        Cairo, located only ten minutes away from Heliopolis and Nasr City and
        twenty minutes from Downtown Cairo.
      </Text>
      ...
      <Text style={styles.textP}>
        ...
        units that vary from apartment to villa accommodations, in addition to a
        wide variety of amenities.
      </Text>

      <Text style={styles.textP}>
        Al Rehab is designed to accommodate 32,385 Apartment and 3741 Villas.
        Moreover, Al Rehab enjoys a fully integrated services plan including but
        not limited to commercial markets, shopping Malls, Food courts, offering
        educational mix from International, National, and experimental Schools,
        A Sporting and Social Club, 4 Medical Centers, An Internal and external
        Transportation Network, Banks and Money Exchange Services.
      </Text>
