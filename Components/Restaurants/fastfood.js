...
const Fastfood = () => {
    const { fastfood, fontsLoaded } = useContext(DataContext);
    ...
    return (
       <>
        ...
        <Text style={{ fontSize: 20, fontWeight: "bold", marginLeft: 21, color:"#112D4E", marginTop:20}}>Fast food Restaurants</Text>
        {fastfood.map((ele) => (
