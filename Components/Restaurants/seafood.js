...
const Seafood = () => {
    const { seafood, fontsLoaded } = useContext(DataContext);
    ...
    return (
       ...
       <ScrollView style={{backgroundColor:"white"}} >
        <Text style={{ fontSize: 20, fontWeight: "bold", marginLeft: 21, color:"#112D4E", marginTop:20}}>Seafood Restaurants</Text>
        {seafood.map((ele) => (
